 ...
 * @version 1.1
 */
public class DICOMViewer_old extends Activity implements SeekBar.OnSeekBarChangeListener {
     ...
     */
    private PairArrayAdapter mArrayAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mArrayAdapter = new PairArrayAdapter(this, R.layout.metadata_item,
                ...
                public void handleMessage(Message message) {
                    ...
                    switch (message.what) {
                        ...
                        case ThreadState.CATCHABLE_ERROR_OCCURRED:
                            cachingDialog.setProgress(message.arg1);
                            Toast.makeText(DICOMViewer_old.this, "[Error]: file ("
                        ...
                        case ThreadState.UNCATCHABLE_ERROR_OCCURRED:
                            ...
                            AlertDialog.Builder builder = new AlertDialog.Builder(DICOMViewer_old.this);
                        ...
                        case ThreadState.OUT_OF_MEMORY:
                            ...
                            builder = new AlertDialog.Builder(DICOMViewer_old.this);
